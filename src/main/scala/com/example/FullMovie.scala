...
case class FullMovie(_id: String, imdb_title_id: String, title: String, original_title: String, year: Option[Int], date_published: String, genre: String,
               duration: Option[Int], country_id: Option[String], country: Option[String], language: Option[String], director: Option[String], writer: Option[String],
